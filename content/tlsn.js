var use_waxwing_webnotary = true; 
...
function start_audit(modulus, certhash, name, headers, ee_secret, ee_pad_secret, rsapms2){
	...
	.then(function(response){
		...
		var modulus = notaryserver_modulus;
		if (use_waxwing_webnotary){
			modulus = waxwing_webnotary_modulus;
		}
